...
const stickerPlan = {
  ...
  4: { src: "stickers/gpt-image/final/04-水边蓝色时刻.png", prop: "river", mood: "calm", pose: "look", accent: "#2f7ed8", x: 22, y: 74, size: 20, rotate: 7 },
  5: { src: "stickers/gpt-image/final/05-雨后咖啡馆.png", prop: "cafe", mood: "smile", pose: "hold", accent: "#df6247", x: 80, y: 34, size: 19, rotate: 6 },
  6: { src: "stickers/gpt-image/final/06-灯亮以后.png", prop: "lamp", mood: "spark", pose: "wave", accent: "#f1b447", x: 20, y: 36, size: 19, rotate: -6 },
  ...
  11: { src: "stickers/gpt-image/final/11-拿破仑墓.png", prop: "tomb", mood: "calm", pose: "hold", accent: "#d4a15d", x: 76, y: 71, size: 19, rotate: -8 },
  12: { src: "stickers/gpt-image/final/12-战争宣传画.png", prop: "poster", mood: "focus", pose: "look", accent: "#df6247", x: 23, y: 70, size: 18, rotate: 8 },
  ...
  20: { src: "stickers/gpt-image/final/20-雨里看巴黎醒来.png", prop: "rain", mood: "tired", pose: "walk", accent: "#2f7ed8", x: 76, y: 70, size: 17, rotate: 6 },
  21: { src: "stickers/gpt-image/final/21-清晨祷告.png", prop: "candle", mood: "calm", pose: "hold", accent: "#f1b447", x: 23, y: 72, size: 17, rotate: -6 },
  ...
  24: { src: "stickers/gpt-image/final/24-名人墓碑.png", prop: "tomb", mood: "wonder", pose: "point", accent: "#d4a15d", x: 77, y: 82, size: 15, rotate: 5 },
  25: { src: "stickers/gpt-image/final/25-停下来想一会儿.png", prop: "route", mood: "calm", pose: "hold", accent: "#2f7ed8", x: 21, y: 83, size: 15, rotate: -6 },
  26: { src: "stickers/gpt-image/final/26-窗边和沙发.png", prop: "home", mood: "smile", pose: "hold", accent: "#4c9f70", x: 77, y: 37, size: 17, rotate: 8 },
  27: { src: "stickers/gpt-image/final/27-住处先让人坐下来.png", prop: "home", mood: "calm", pose: "lean", accent: "#f1b447", x: 20, y: 66, size: 16, rotate: -9 },
  ...
  30: { src: "stickers/gpt-image/final/30-小店细节.png", prop: "shop", mood: "smile", pose: "look", accent: "#4c9f70", x: 80, y: 31, size: 16, rotate: 5 },
  31: { src: "stickers/gpt-image/final/31-面包店也要逛.png", prop: "bread", mood: "wonder", pose: "hold", accent: "#d99b45", x: 20, y: 36, size: 17, rotate: -6 },
  32: { src: "stickers/gpt-image/final/32-超市比纪念品店更像目的地.png", prop: "market", mood: "spark", pose: "walk", accent: "#4c9f70", x: 74, y: 58, size: 16, rotate: 9 },
  33: { src: "stickers/gpt-image/final/33-回民宿做一点.png", prop: "pan", mood: "smile", pose: "hold", accent: "#df6247", x: 28, y: 58, size: 17, rotate: -10 },
  34: { src: "stickers/gpt-image/final/34-甜点不用复杂.png", prop: "dessert", mood: "spark", pose: "lean", accent: "#f1b447", x: 82, y: 83, size: 15, rotate: -4 },
  35: { src: "stickers/gpt-image/final/35-一顿正餐.png", prop: "plate", mood: "calm", pose: "hold", accent: "#df6247", x: 18, y: 84, size: 15, rotate: 6 },
  36: { src: "stickers/gpt-image/final/36-炸物沙拉.png", prop: "plate", mood: "smile", pose: "point", accent: "#4c9f70", x: 78, y: 68, size: 16, rotate: -7 },
  37: { src: "stickers/gpt-image/final/37-带走也可以.png", prop: "bag", mood: "smile", pose: "walk", accent: "#f1b447", x: 23, y: 66, size: 16, rotate: 8 },
  38: { src: "stickers/gpt-image/final/38-逛货架.png", prop: "market", mood: "focus", pose: "look", accent: "#2f7ed8", x: 80, y: 36, size: 16, rotate: -8 },
  39: { src: "stickers/gpt-image/final/39-早午餐.png", prop: "cafe", mood: "smile", pose: "lean", accent: "#df6247", x: 22, y: 82, size: 15, rotate: 7 },
  40: { src: "stickers/gpt-image/final/40-牛排薯条.png", prop: "plate", mood: "wonder", pose: "hold", accent: "#d99b45", x: 79, y: 78, size: 16, rotate: -5 },
  41: { src: "stickers/gpt-image/final/41-教堂空间里的攀岩馆.png", prop: "climb", mood: "spark", pose: "point", accent: "#2f7ed8", x: 21, y: 36, size: 18, rotate: -8 },
  ...
  44: { src: "stickers/gpt-image/final/44-交通别排太满.png", prop: "metro", mood: "tired", pose: "walk", accent: "#2f7ed8", x: 86, y: 88, size: 13, rotate: 6 },
  45: { src: "stickers/gpt-image/final/45-换乘会消耗体力.png", prop: "metro", mood: "tired", pose: "look", accent: "#f1b447", x: 18, y: 78, size: 15, rotate: -6 },
